...
from HelmertTool.logic.regression import *
...
stations_df = pd.read_fwf("C:/Users/Adrian/Documents/NVI/HelmertTool/data/core_network_ITRF2014.txt", skiprows=5)
...
df_to = stations_df.merge(df_2008, how = "left", on=["Domes", "Soln", "Code"])
